...
<body>
	<%
		...
		recordTableOP objVMR = new recordTableOP();
		objArr = objVMR.getRecordData(vmid);
	%>
...
<div class="container">
    ...
    <div class ="table-container">
    	<h1 class ="heading" >Record</h1>    
    	<div align="center" >
    <div class="field padding-bottom--24">
     	<a href="V_Details.jsp?vmid=<% out.print(vmid);%>">
    ...
    <input type="submit" name="Coins" value="Coins">
    	...
    	<table class="table">
    		...
    		%>
    			<tr>
    				<td date-label="record_id"><%out.print(obj.get("id"));%></td>
    				<td date-label="Vm_id"><%out.print(obj.get("vm_id"));%></td>
    				<td date-label="Product_id"><%out.print(obj.get("product_id"));%></td>
    				<td date-label="time_stamp"><%out.print(obj.get("timetamp"));%></td>
    				<td date-label="Quantity"><%out.print(obj.get("product_quantity"));%></td>
    				<td date-label="action"><%out.print(obj.get("action"));%></td>
