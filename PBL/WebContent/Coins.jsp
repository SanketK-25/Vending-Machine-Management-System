...
<body>
		<%  
            ...
            coinboxTableOP objVMR = new coinboxTableOP();
        	objArr=objVMR.getCollectionData(vmid);
        %>
 <div class="container">
    ...
    <div class ="table-container">
    	<h1 class ="heading" >Coin_Box</h1>  

    	<div class="field padding-bottom--24">
     	<a href="V_Details.jsp">
    ...
    <input type="submit" name="Record" value="Record">
    	...
    	<table class="table">
			...
			%>
    			<tr>
    				<td date-label="Collection_id"><%out.print(obj.get("id"));%></td>
    				<td date-label="vm_id"><%out.print(obj.get("vmid"));%></td>
    				<td date-label="amount"><%out.print(obj.get("vmid"));%></td>
    				<td date-label="timestamp"><%out.print(obj.get("vmid"));%></td>
